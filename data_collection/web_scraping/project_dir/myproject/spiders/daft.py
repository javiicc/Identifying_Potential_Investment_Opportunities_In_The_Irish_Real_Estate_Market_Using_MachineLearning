...
class DaftSpider(CrawlSpider, ABC):
    ...
    def parse_items_buy(self, response):
        ...
        xpath_contact = '//div[@class="ContactPanel__Container-sc-18zt6u1-7 '\
                        'fCElaB"]/div[2]/p/text()'
        ...
        xpath_coordinates = '//div[@class="NewButton__ButtonContainer-yem86a-4 dFKaNf button-'\
                            'container"]/a'
        xpath_description = '//div[@data-testid="description"]/text()'
        ...
        # Extract description
        get_description(xpath=xpath_description, 
                        response=response, 
                        loader=item_loader)
    ...
    def parse_items_rent(self, response):
        ...
        xpath_license = '//div[@class="PropertyPage__MainColumn-sc-14jmnho-1 hwqROB"]/div[5][1]'
        xpath_energy = '//p[@data-testid="ber-epi"]/span[2]/text()'
        xpath_coordinates = '//div[@class="NewButton__ButtonContainer-yem86a-4 dFKaNf '\
                            'button-container"]/a'
        xpath_description = '//div[@data-testid="description"]/text()'
