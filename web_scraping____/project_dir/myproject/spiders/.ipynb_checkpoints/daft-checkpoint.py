...
from daftpy.daftdata import DaftLoader
...
class DaftSpider(CrawlSpider, ABC):
    ...
    def parse_items_buy(self, response):
        ...
        # We obtain an id from the ad's url with the help of the function `findall` and 
        # the package `re`
    ...
    def parse_items_rent(self, response):
        ...
        item_loader = DaftLoader(DaftItemRent(), response)
